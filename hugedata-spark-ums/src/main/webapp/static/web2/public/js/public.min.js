$(function(){
	...
	/*$(".banner_bg li").click(function(){  //  导航高亮
		$(this).addClass('on').siblings().removeClass('on');
	});*/

	var curMenuIndex = $(".banner_bg .menu li.on").index(); //  导航高亮
	$(".banner_bg .menu li").hover(function(){ //导航二级菜单显示
		$(this).children(".menu_down").show().end().addClass('on').siblings().removeClass('on').children('.menu_down').hide();
	});
	$(".banner_bg").on('mouseleave',function(){
		if(curMenuIndex == "-1"){
			$(".banner_bg .menu li").removeClass('on').children(".menu_down").hide();
		}else{
			$(".banner_bg .menu li").eq(curMenuIndex).children(".menu_down").show().end().addClass('on').siblings().removeClass('on').children('.menu_down').hide();
		}
	});

	$("#minH").css('min-height',$(window).height()-515);//最小高度
	$(".password-content").css('min-height',$(window).height()-425);//最小高度
