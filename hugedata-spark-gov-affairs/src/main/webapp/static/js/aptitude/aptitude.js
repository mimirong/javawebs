...
angular.module("aptitudeListModule", [])
    .controller("aptitudeListController", [ "$scope", "$http", "$timeout", function($scope, $http, $timeout) {
        ...
        $scope.reload = function() {
            $http({
                url: contextPath + "/aptitude/query",
                method: "get",
                params: {
        ...
        $scope.aptitude = function () {
            window.location.href=contextPath + "/aptitude/list";
        };
