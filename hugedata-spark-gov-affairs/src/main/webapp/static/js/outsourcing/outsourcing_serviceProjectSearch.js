angular.module("outsourcingServiceProjectSearchModule", [])
    .controller("outsourcingServiceProjectSearchController", ["$scope", function ($scope) {
