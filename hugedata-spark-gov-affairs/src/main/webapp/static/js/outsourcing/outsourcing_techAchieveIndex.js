angular.module("techAchieveIndexModule", [ "sparkGlobal" ])

//Controller
.controller("techAchieveIndexController", ["$scope", function($scope) {
	$scope.isLoading = false;					//是否显示正在加载
	$scope.page = { start: 0, length: 15 };		//分页信息，一页查9条(3 x 3)
