angular.module("expertsIndexModule", [ "sparkGlobal" ])

//Controller
.controller("expertsIndexController", ["$scope", function($scope) {
	$scope.isLoading = false;					//是否显示正在加载
	$scope.page = { start: 0, length: 10 };		//分页信息
	...
	$scope.loadData = function() {
      ...
      //  $scope.currProfessionFieldId = $("#currProfessionFieldId").val();
...
//        $("#currProfessionFieldId").val(value);
