angular.module("techStorageApplyListModule", [])
	.controller("techStorageApplyListController", [ "$scope", "$http", "$filter", function($scope, $http, $filter) {
		...
		$scope.viewApply = null;     //当前详情显示的申请信息
