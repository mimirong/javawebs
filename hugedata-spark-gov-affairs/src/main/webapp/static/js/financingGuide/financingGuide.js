...
angular.module("financingGuideListModule", ["sparkGlobal"])
    .controller("financingGuideListController", [ "$scope", "$http", "$timeout", function($scope, $http, $timeout) {
        ...
        $scope.reload = function() {
            $http({
                url: contextPath + "/financingGuide/query",
                method: "get",
                params: {
