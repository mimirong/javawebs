...
<body>
    <div class="column_list ng-cloak" ng-app="techStorageApplyListModule" ng-controller="techStorageApplyListController">
		    ...
		    <ul class="leftsidebar">
		      ...
		      <li class="active">
		          ...
		          <dl style="display: block;">
		              <dd class="on"><a href="${contextPath}/outsourcing/tech/storage/applyList">申请记录 </a></dd>
    ...
    <div class="alert" style="display:none; width:600px;" id="viewApplyPanel" name="wh_alert">
		<div class="title"><a href="javascript:;" onclick="MU.hide(this)"></a><span>云存储申请详情</span></div>
		<div class="pop-content" style="padding: 30px 0;">
		    <ul class="form clearfix">
		        <li class="clearfix"><label class="tit">储存规格：</label><span class="">{{viewApply.specName}}</span></li>
		        <li class="clearfix"><label class="tit">时长：</label><span class="">{{viewApply.serviceDuration}}个月</span></li>
		        <li class="clearfix"><label class="tit">数量：</label><span class="">{{viewApply.amount}}</span></li>
		        <li class="clearfix"><label class="tit">费用总计：</label><span class="">{{viewApply.price}}元</span></li>
...
<script type="text/javascript" src="${contextPath}/static/js/tech/storage_applylist.js?v=${buildTimestamp}"></script>
</body>
</html>