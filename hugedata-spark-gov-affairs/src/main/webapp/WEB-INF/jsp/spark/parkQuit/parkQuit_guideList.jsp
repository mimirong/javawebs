...
<div class="ng-cloak" ng-app="parkQuitGuideListModule" ng-controller="parkQuitGuideListController">
      ...
      <ul class="leftsidebar">
        ...
        <li class="active">
            ...
            <dl style="display:block;">
                <dd class="on"><a href="${contextPath}/parkQuit/listGuide">退园指南</a></dd>
...
<script src="${contextPath}/static/js/parkQuit/parkQuit_guideList.js?v=${buildTimestamp}"></script>
