...
<body>
  ...
  <div class="column_con clearfix" style="padding: 0 20px 35px; width: 960px;">
      ...
      <div class="tab" style="width:173px">
      	<a href="details?guideId=${guideId}">办事指南</a><a href="details2?guideId=${guideId}" class="on">办事流程</a>
	      <%-- 
      ...
      <div class="tab-content">
          ...
          <div class="content">
          	<c:if test="${guide.flowImageFileId != null && guide.flowImageFileId != ''}">
              <img src="${flowImageUrl}" alt="" style="max-width:850px" />
            </c:if>
          </div>
      </div>
  </div>
