...
<div class="ng-cloak" ng-app="docModule" ng-controller="docController">   
  ...
  <div class="column_con clearfix" id="minH">
   <input type="hidden" id="typeCodeBegin" value="100"/>
      ...
      <div class="tab w434"><a href="detail?projectId=${projectId }">基本信息</a><a  class="on" href="doc1?projectId=${projectId }">手续文件</a><a href="doc2?projectId=${projectId }">文档资料</a><a href="monthReport?projectId=${projectId }">项目月报</a><a href="yearPlan?projectId=${projectId }">年度计划</a></div>
  ...
  <form name="form" action="${contextPath}/pmProject/addDoc" enctype="multipart/form-data" method="post">
	  ...
	  <input type="hidden" name="typeCode" value=""/>
	   <input type="hidden" name="docType" value="1"/>
        <li class="clearfix"><label class="tit"><em>*</em>文件类型：</label>
        ...
        <li class="clearfix"><label class="tit"><em>*</em>文件名称：</label><input type="text" name="fileName" class="text w300" value=""/></li>
        <li class="clearfix"><label class="tit"><em>*</em>批复文号：</label><input type="text" name="approveCode" class="text w300" value=""/></li>
  ...
  <form name="form" action="${contextPath}/pmProject/modifyDoc" enctype="multipart/form-data" method="post">
	  ...
	  <input type="hidden" name="docType" value="1"/>
        ...
        <li class="clearfix"><label class="tit"><em>*</em>文件名称：</label><input type="text" name="fileName" class="text w300" value=""/></li>
        <li class="clearfix fileName"><label class="tit"><em>*</em>批复文号：</label><input type="text" name="approveCode" class="text w300" value=""/></li>
        <li class="clearfix"><label class="tit"><em>*</em>选择上传文件：</label><input type="file" name="fileContent" value="上传申请材料"/></li>
