...
<body>
<div class="ng-cloak" ng-app="serviceListMyModule" ng-controller="serviceListMyController">
    <h1 class="column_tit">您当前位置：
    	...
    	<a href="${contextPath}/serviceGuide1/serviceListMy">我的办件</a> 
   	</h1>
  <!--content-start-->
  <div class="column_con clearfix" style="padding: 0 20px 35px; width: 960px;">
      <h2 class="title">我的办件<a class="blue fr" href="serviceShow">返回办件公示 >></a></h2>
...
<script src="${contextPath}/static/js/serviceGuide/serviceListMy.js?v=${buildTimestamp}"></script>
