  ...
  <div class="column_con clearfix" style="padding: 0 20px 35px; width: 960px;">
     ...
     <div class="tab" style="width:347px">
				<a href="details?guideId=${guideId}">办事指南</a><a
					...
					href="details3?guideId=${guideId}" class="on">表格下载</a><a
      ...
      <div class="tab-content">
          ...
          <div class="content">
          	  ...
          	  <div ng-if="!attachments || attachments.length == 0" style="height:200px; text-align:center;">
          	  	  <p>没有数据</p>
          	  </div>
          
              <ul class="list" ng-if="attachments && attachments.length > 0">
                  <li ng-repeat="att in attachments">
                  	<a href="{{att.fileId | makeUrl:att.fileName}}">{{att.fileName}}</a>
                  </li>
              </ul>
          </div>
      </div>
