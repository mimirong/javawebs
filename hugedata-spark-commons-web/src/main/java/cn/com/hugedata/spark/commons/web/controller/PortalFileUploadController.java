...
/**
 * 用于前台FileUploadTag的文件上传处理.
 * @author gaopeng
 */
@Controller(value = "commonsWebPortalFileUploadController")
@RequestMapping("/commons-web/portal-file-upload")
public class PortalFileUploadController implements ServletContextAware {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(PortalFileUploadController.class);
    ...
    public ModelAndView upload(
        ...
        try {
            ...
            ModelAndView mv = new ModelAndView("redirect:/commons-web/portal-file-upload/toFileUploadResult-simple");
            mv.addObject("err", "");
