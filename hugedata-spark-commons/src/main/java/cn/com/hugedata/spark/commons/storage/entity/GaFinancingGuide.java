...
public class GaFinancingGuide extends BaseEntity<Integer> {
    /**
     * guideId
     */
    ...
    private static final long serialVersionUID = -7285016922212934923L;
    ...
    public void setPublishDept(String publishDept) {
        this.publishDept = publishDept == null ? null : publishDept.trim();
    }
    ...
    public static JSONObject toJSON(GaFinancingGuide e) {
    ...
    public static List<JSONObject> toJSON(List<GaFinancingGuide> list) {
    ...
    public JSONObject toJSON() {
        return GaFinancingGuide.toJSON(this);
    }
    ...
    public static class Fields {
        ...
        public static final String PUBLISH_DEPT = "publishDept";
    ...
    public static class Query {
        ...
        public static final String PUBLISH_DEPT__NE = "ne_publishDept";

        public static final String PUBLISH_DEPT__LIKE = "like_publishDept";

        public static final String PUBLISH_DEPT__IN = "list_publishDept";

        public static final String PUBLISH_DEPT__BEGIN = "begin_publishDept";

        public static final String PUBLISH_DEPT__END = "end_publishDept";
