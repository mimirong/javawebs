...
public class GaParkJoinGuide extends BaseEntity<Integer> {
    /**
     * guideId
     */
    ...
    private static final long serialVersionUID = 8689944033781113989L;
    ...
    public static JSONObject toJSON(GaParkJoinGuide e) {
    ...
    public static List<JSONObject> toJSON(List<GaParkJoinGuide> list) {
    ...
    public JSONObject toJSON() {
        return GaParkJoinGuide.toJSON(this);
    }
