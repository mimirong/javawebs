...
public class PtArticleImage extends BaseEntity<Integer> {
    /**
     * imageId
     */
    ...
    private static final long serialVersionUID = -5594082043070027678L;
    ...
    public static JSONObject toJSON(PtArticleImage e) {
    ...
    public static List<JSONObject> toJSON(List<PtArticleImage> list) {
    ...
    public JSONObject toJSON() {
        return PtArticleImage.toJSON(this);
    }
