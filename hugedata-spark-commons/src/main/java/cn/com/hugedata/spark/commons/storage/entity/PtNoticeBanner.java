...
import cn.com.hugedata.spark.commons.storage.constant.PtNoticeBannerConstants;
...
public class PtNoticeBanner extends BaseEntity<Integer> implements PtNoticeBannerConstants {
    /**
     * imageId
     */
    ...
    private static final long serialVersionUID = 5005020509120068246L;
    ...
    public static JSONObject toJSON(PtNoticeBanner e) {
    ...
    public static List<JSONObject> toJSON(List<PtNoticeBanner> list) {
    ...
    public JSONObject toJSON() {
        return PtNoticeBanner.toJSON(this);
    }
