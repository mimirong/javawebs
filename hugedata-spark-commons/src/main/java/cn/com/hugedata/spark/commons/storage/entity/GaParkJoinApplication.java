...
public class GaParkJoinApplication extends BaseEntity<Integer> implements GaParkJoinApplicationConstants {
    /**
     * applicationId
     */
    ...
    private static final long serialVersionUID = -6610659542711339129L;
    ...
    public static JSONObject toJSON(GaParkJoinApplication e) {
    ...
    public static List<JSONObject> toJSON(List<GaParkJoinApplication> list) {
    ...
    public JSONObject toJSON() {
        return GaParkJoinApplication.toJSON(this);
    }
