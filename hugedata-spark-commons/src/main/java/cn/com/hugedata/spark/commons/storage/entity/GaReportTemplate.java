...
public class GaReportTemplate extends BaseEntity<Integer> {
    /**
     * templateId
     */
    ...
    private static final long serialVersionUID = 5676916952262915210L;
    ...
    public static JSONObject toJSON(GaReportTemplate e) {
    ...
    public static List<JSONObject> toJSON(List<GaReportTemplate> list) {
    ...
    public JSONObject toJSON() {
        return GaReportTemplate.toJSON(this);
    }
