...
import cn.com.hugedata.spark.commons.storage.constant.PtHomeImageConstants;
...
public class PtHomeImage extends BaseEntity<Integer> implements PtHomeImageConstants {
    /**
     * imageId
     */
    ...
    private static final long serialVersionUID = -7815950468441923599L;
    ...
    public static JSONObject toJSON(PtHomeImage e) {
    ...
    public static List<JSONObject> toJSON(List<PtHomeImage> list) {
    ...
    public JSONObject toJSON() {
        return PtHomeImage.toJSON(this);
    }
