...
public class GaSiteProof extends BaseEntity<Integer> {
    /**
     * siteProofId
     */
    private Integer siteProofId;
    ...
    private static final long serialVersionUID = 5012515484879807749L;

    /**
     * {@link #siteProofId}
     */
    public Integer getSiteProofId() {
        return siteProofId;
    }
     ...
     * {@link #siteProofId}
     */
    public void setSiteProofId(Integer siteProofId) {
        this.siteProofId = siteProofId;
    }
    ...
    public static JSONObject toJSON(GaSiteProof e) {
    ...
    public static List<JSONObject> toJSON(List<GaSiteProof> list) {
    ...
    public JSONObject toJSON() {
        return GaSiteProof.toJSON(this);
    }

    public static class Fields {
        public static final String SITE_PROOF_ID = "siteProofId";
    ...
    public static class Query {
        public static final String SITE_PROOF_ID__NE = "ne_siteProofId";

        public static final String SITE_PROOF_ID__IN = "list_siteProofId";

        public static final String SITE_PROOF_ID__BEGIN = "begin_siteProofId";

        public static final String SITE_PROOF_ID__END = "end_siteProofId";
