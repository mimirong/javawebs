...
public class HugedataClientPlugin extends org.mybatis.generator.api.PluginAdapter {
...
//        this.addToStringMethodToModelClass(topLevelClass);
        ...
        // extends BaseEntity
        FullyQualifiedJavaType baseEntityClass = new FullyQualifiedJavaType("cn.com.hugedata.spark.commons.storage.base.BaseEntity");
        ...
        if ("true".equals(introspectedTable.getTableConfigurationProperty(PROPERTY_HAS_CONSTANTS))) {
        	FullyQualifiedJavaType interfaze = new FullyQualifiedJavaType("cn.com.hugedata.spark.commons.storage.constant."
