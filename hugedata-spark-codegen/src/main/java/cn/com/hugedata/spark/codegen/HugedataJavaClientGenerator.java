...
public class HugedataJavaClientGenerator extends JavaMapperGenerator {

	private static final String PROPERTY_MANAGEMENT_INTERFACE = "managementInterface";

    public HugedataJavaClientGenerator() {
        super(true);
    }

    public HugedataJavaClientGenerator(boolean requiresXMLGenerator) {
...
//        interfaze.addAnnotation("@MyBatisRepository");
    ...
    public AbstractXmlGenerator getMatchedXMLGenerator() {
        return new HugedataXmlMapperGenerator();
    }
