...
var columns =[
    {
        ...
        render: function(val) {
            switch (val) {
                case "OS_DETEC_RESOURCE_PLATFORM": 	return "资源平台";
                default:					        return val;
            }
        }
    }, {
        ...
        render: function(row) {
            var m = [];
            if(CommonsPrivileges.hasPrivilegeId("outdetec/resource_platform/preview")){
                m.push('<a href=' + govAffairsPortalUrl + '/outsourcing/details?articleId=' + row.articleId + '&categoryId=' + row.categoryId + '  target ="_black" class="txt-op" data-row-id="' + row.articleId + '">预览</a> ');
            }
            if (CommonsPrivileges.hasPrivilegeId("outdetec/resource_platform/setVisible")) {
                if (row.isVisible) {
            ...
            if (CommonsPrivileges.hasPrivilegeId("outdetec/resource_platform/modify")) {
                m.push('<a class="txt-op btnModify" data-row-id="' + row.articleId + '" href="javascript:;">修改</a>');
            }
            if (CommonsPrivileges.hasPrivilegeId("outdetec/resource_platform/delete")) {
