...
var columns =[
    {
        ...
        render: function(val) {
            switch (val) {
                case "OS_DETEC_TECH_TRAIN": 	    return "技术培训";
                default:					        return val;
            }
        }
    }, {
        ...
        render: function(row) {
            var m = [];
            if(CommonsPrivileges.hasPrivilegeId("outdetec/tech_train/preview")){
            ...
            if (CommonsPrivileges.hasPrivilegeId("outdetec/tech_train/setVisible")) {
                if (row.isVisible) {
            ...
            if (CommonsPrivileges.hasPrivilegeId("outdetec/tech_train/modify")) {
                m.push('<a class="txt-op btnModify" data-row-id="' + row.articleId + '" href="javascript:;">修改</a>');
            }
            if (CommonsPrivileges.hasPrivilegeId("outdetec/tech_train/delete")) {
