...
var columns =[
    {
        ...
        render: function(val) {
            switch (val) {
                case "OS_DETEC_TECH_TRANSFER": 	    return "政策法规";
                default:					        return val;
            }
        }
    }, {
        ...
        render: function(row) {
            var m = [];
            if(CommonsPrivileges.hasPrivilegeId("outdetec/tech_transfer/preview")){
            ...
            if (CommonsPrivileges.hasPrivilegeId("outdetec/tech_transfer/setVisible")) {
                if (row.isVisible) {
            ...
            if (CommonsPrivileges.hasPrivilegeId("outdetec/tech_transfer/modify")) {
                m.push('<a class="txt-op btnModify" data-row-id="' + row.articleId + '" href="javascript:;">修改</a>');
            }
            if (CommonsPrivileges.hasPrivilegeId("outdetec/tech_transfer/delete")) {
