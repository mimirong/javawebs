...
var columns =[
    {
        ...
        render: function(val) {
            switch (val) {
                case "OS_DETEC_ACHIEVE_EXHIBIT": 	return "成果展示";
                default:					        return val;
            }
        }
    }, {
        ...
        render: function(row) {
            var m = [];
            if(CommonsPrivileges.hasPrivilegeId("outdetec/achieve_exhibit/preview")){
            ...
            if (CommonsPrivileges.hasPrivilegeId("outdetec/achieve_exhibit/setVisible")) {
                if (row.isVisible) {
            ...
            if (CommonsPrivileges.hasPrivilegeId("outdetec/achieve_exhibit/modify")) {
                m.push('<a class="txt-op btnModify" data-row-id="' + row.articleId + '" href="javascript:;">修改</a>');
            }
            if (CommonsPrivileges.hasPrivilegeId("outdetec/achieve_exhibit/delete")) {
