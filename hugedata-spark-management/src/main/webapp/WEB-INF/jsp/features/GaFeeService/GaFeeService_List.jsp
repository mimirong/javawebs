...
<body>
    ...
    <div class="alert" style="display:none; width:1000px;" id="addPanel" name="wh_alert">
		...
		<div class="pop-content" style="">
 			<input type="hidden" id="categoryId" value="GA_FEES" />
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/GaFeeService_List.js?v=${buildTimestamp}"></script>
