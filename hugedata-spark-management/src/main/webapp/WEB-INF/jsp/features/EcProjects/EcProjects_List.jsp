...
<head>
	...
	<title>项目对接</title>
	<script>
		currentMenu = "ecomm/projects";
		currentSystem = "OUTSOURCING";
	</script>
</head>
<body>

	<h2 class="title">项目对接</h2>
    ...
    <div class="alert" style="display:none; width:1000px;" id="addPanel" name="wh_alert">
		...
		<div class="pop-content" style="">
 			<input type="hidden" id="categoryId" value="ECOMM_PROJECTS" />
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/EcProjects_List.js?v=${buildTimestamp}"></script>
