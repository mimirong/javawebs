...
<head>
	...
	<title>金融服务</title>
	<script>
		currentMenu = "ecomm/financing";
		currentSystem = "OUTSOURCING";
	</script>
</head>
<body>

	<h2 class="title">金融服务</h2>
    ...
    <div class="alert" style="display:none; width:1000px;" id="addPanel" name="wh_alert">
		...
		<div class="pop-content" style="">
 			<input type="hidden" id="categoryId" value="ECOMM_FINANCING" />
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/EcFinancing_List.js?v=${buildTimestamp}"></script>
