...
<head>
    ...
    <title>政策法规</title>
    <script>
        currentMenu = "outdetec/tech_transfer";
            ...
            <li class="clearfix"><label class="tit w84"><em>*</em>所属栏目：</label>
                <span class="select" style="width:478px;">
		                <select id="categoryId">
		                    ...
		                    <option value="OS_DETEC_TECH_TRANSFER">政策法规</option>
		                </select>
		            </span>
            </li>
...
<script type="text/javascript" src="${contextPath}/static/js/spark/OsDetecTechTransfer_List.js?v=${buildTimestamp}"></script>
