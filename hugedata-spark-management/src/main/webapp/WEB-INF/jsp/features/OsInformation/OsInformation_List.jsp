...
<head>
	...
	<title>企业信息服务</title>
	<script>
		currentMenu = "outtech/information";
		currentSystem = "OUTSOURCING";
	</script>
</head>
<body>

	<h2 class="title">企业信息服务</h2>
		        ...
		        <li class="clearfix"><label class="tit w84"><em>*</em>所属栏目：</label>
		            <span class="select" style="width:478px;">
		                <select id="categoryId">
		                    ...
		                    <option value="INFORMATION_COMPANIES">企业信息库</option>
		                    <option value="INFORMATION_PRODUCTS">产品信息库</option>
		                </select>
		            </span>
		        </li>
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/OsInformation_List.js?v=${buildTimestamp}"></script>
