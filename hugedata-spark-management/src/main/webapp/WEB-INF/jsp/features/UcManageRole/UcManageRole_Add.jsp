...
<body>
	...
	<div class="feature-content-internal">
		...
		<div class="form-wrapper">
			...
			<form class="form-horizontal" role="form" method="post" action="doAdd" id="mainForm" onsubmit="return false;">
			
				<div class="form-group">
					<label for="roleId" class="col-xs-3 control-label">角色ID <span class="required">*</span>：</label>
					<div class="col-xs-9">
						<input type="text" class="form-control" id="roleId" name="roleId" maxlength="32" placeholder="输入角色ID" />
					</div>
				</div>
			...
			<div class="text-center">
				<button type="button" class="btn btn-primary btn-md" onclick="$('#mainForm').submit();">创建角色</button>
			</div>			
		</div><!-- .form-wrapper -->
