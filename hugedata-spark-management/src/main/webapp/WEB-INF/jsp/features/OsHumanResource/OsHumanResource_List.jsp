...
<body>
		        ...
		        <li class="clearfix"><label class="tit w84"><em>*</em>所属栏目：</label>
		            <span class="select" style="width:478px;">
		                <select id="categoryId">
		                    ...
		                    <option value="HUMAN_RESOURCE_1">人才培训</option>
		                    <option value="HUMAN_RESOURCE_2">技术职称招考</option>
		                    <option value="HUMAN_RESOURCE_3">企业招聘</option>
		                </select>
		            </span>
		        </li>
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/OsHumanResource_List.js?v=${buildTimestamp}"></script>
