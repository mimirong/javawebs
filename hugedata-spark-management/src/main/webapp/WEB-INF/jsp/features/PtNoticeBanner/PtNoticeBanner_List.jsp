...
<head>
    ...
    <title>专题栏目</title>
    <script>
        currentMenu = "notice_banner";
        currentSystem = "INFORMATION";
    </script>
</head>
<body>
    <h2 class="title">专题栏目</h2>
                ...
                <li class="clearfix" id="imageFileWrapper">
                    ...
                    <div style="float:left">
                        <div id="fileDiv">
                            ...
                            <span id="fileTip" style="color:#f00">建议图片尺寸960x120，大小不能超过10M，建议不超过1M</span>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <script type="text/javascript" src="${contextPath}/static/js/spark/PtNoticeBanner.js?v=${buildTimestamp}"></script>
</body>
</html>
