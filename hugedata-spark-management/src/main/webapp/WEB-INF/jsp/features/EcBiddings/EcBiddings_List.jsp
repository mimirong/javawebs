...
<head>
	...
	<title>招标公告</title>
	<script>
		currentMenu = "ecomm/biddings";
		currentSystem = "OUTSOURCING";
	</script>
</head>
<body>

	<h2 class="title">招标公告</h2>
    ...
    <div class="alert" style="display:none; width:1000px;" id="addPanel" name="wh_alert">
		...
		<div class="pop-content" style="">
 			<input type="hidden" id="categoryId" value="ECOMM_BIDDINGS" />
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/EcBiddings_List.js?v=${buildTimestamp}"></script>
