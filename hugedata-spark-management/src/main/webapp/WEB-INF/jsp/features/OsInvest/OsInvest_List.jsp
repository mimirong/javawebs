...
<head>
	...
	<title>项目招商服务</title>
	<script>
		currentMenu = "outtech/invest";
		currentSystem = "OUTSOURCING";
	</script>
</head>
<body>

	<h2 class="title">项目招商服务</h2>
		        ...
		        <li class="clearfix"><label class="tit w84"><em>*</em>所属栏目：</label>
		            <span class="select" style="width:478px;">
		                <select id="categoryId">
		                    ...
		                    <option value="OSINVEST_1">招商信息</option>
		                    <option value="OSINVEST_2">资源展示</option>
		                </select>
		            </span>
		        </li>
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/OsInvest_List.js?v=${buildTimestamp}"></script>
