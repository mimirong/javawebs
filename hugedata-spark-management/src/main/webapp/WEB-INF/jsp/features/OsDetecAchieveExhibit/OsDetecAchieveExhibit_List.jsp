...
<head>
    ...
    <title>成果展示</title>
    <script>
        currentMenu = "outdetec/achieve_exhibit";
            ...
            <li class="clearfix"><label class="tit w84"><em>*</em>所属栏目：</label>
                <span class="select" style="width:478px;">
		                <select id="categoryId">
		                    ...
		                    <option value="OS_DETEC_ACHIEVE_EXHIBIT">成果展示</option>
		                </select>
		            </span>
            </li>
...
<script type="text/javascript" src="${contextPath}/static/js/spark/OsDetecAchieveExhibit_List.js?v=${buildTimestamp}"></script>
