...
<body>
	...
	<h2 class="title">退园指南</h2>
	<%--
    <div class="tab"><a href="${contextPath}/features/GaParkQuitApplication/list">申请审批</a><a href="${contextPath}/features/GaParkQuitGuide/list" class="on">退园指南</a></div>
	--%>
    ...
    <div class="alert" style="display:none; width:950px;" id="addPanel" name="wh_alert">
		...
		<div class="pop-content" style="padding-top:8px;">
			<ul class="form clearfix" style="padding:10px 0; overflow:auto;">
				<li><label class="tit"><em>*</em>名称：</label><input type="text" class="text w460" value="" name="title" id="title" maxlength="100" /></li>
				<li><label class="tit"><em>*</em>发布部门：</label><input type="text" class="text w460" value="" name="creatorDept" id="creatorDept" maxlength="100" /></li>
				<li><label class="tit"><em>*</em>发布人：</label><input type="text" class="text w220" value="${SPARK_LOGIN.name}" name="creatorName" id="creatorName" maxlength="100" /></li>
				<li><label class="tit"><em>*</em>发布日期：</label><input type="text" class="text w220 dateInput" id="publishTimeStr" name="publishTimeStr" /></li>
		        <li class="clearfix">
		        	<label class="tit"><em>*</em>内容：</label>
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/GaParkQuitGuide_List.js?v=${buildTimestamp}"></script>
