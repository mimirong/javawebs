...
<head>
	...
	<title>服务外包</title>
	<script>
		currentMenu = "ecomm/outsourcing";
		currentSystem = "OUTSOURCING";
	</script>
</head>
<body>

	<h2 class="title">服务外包</h2>
    ...
    <div class="alert" style="display:none; width:1000px;" id="addPanel" name="wh_alert">
		...
		<div class="pop-content" style="">
 			<input type="hidden" id="categoryId" value="ECOMM_OUTSOURCING" />
	...
	<script type="text/javascript" src="${contextPath}/static/js/spark/EcOutsourcing_List.js?v=${buildTimestamp}"></script>
