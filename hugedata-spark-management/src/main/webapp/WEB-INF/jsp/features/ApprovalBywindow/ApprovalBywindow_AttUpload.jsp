...
<body>
	...
	<div style="height:26px; width:30px; overflow:hidden; background-color:white;">
		<div id="uplaodPanel" style="padding:4px 0;">
			<form id="uploadForm" action="doAttUpload" method="post" enctype="multipart/form-data">
				<input type="hidden" name="callback" value="${callback}" />
				<input type="hidden" name="attConfigId" value="${attConfigId}" />
				<a href="javascript:;" style="color:#107aee; cursor:pointer;" id="uploadButton">
					<span>上传</span>
		...
		if (isResult && window.parent) {
			...
			if (fn && typeof fn === "function") {
				if (isError) {
					...
					response.attConfigId = attConfigId;
					fn(null, response);
				}
			}
		}
