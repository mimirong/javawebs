...
<head>
    ...
    <title>资源平台</title>
    <script>
        currentMenu = "outdetec/resource_platform";
        currentSystem = "OUTSOURCING";
    </script>
</head>
<body>
<h2 class="title">资源平台</h2>
            ...
            <li class="clearfix"><label class="tit w84"><em>*</em>所属栏目：</label>
                <span class="select" style="width:478px;">
		                <select id="categoryId">
		                    ...
		                    <option value="OS_DETEC_RESOURCE_PLATFORM">资源平台</option>
		                </select>
		            </span>
            </li>
...
<script type="text/javascript" src="${contextPath}/static/js/spark/OsDetecResourcePlatform_List.js?v=${buildTimestamp}"></script>
