...
@Controller
@RequestMapping("/features/OsInformation")
public class OsInformationController
        extends FeatureControllerImpl<PtArticle, Integer, OsInformationService, OsInformationModel> {
