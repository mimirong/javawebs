...
@Controller
@RequestMapping("/features/GaFeeService")
public class GaFeeServiceController
        extends FeatureControllerImpl<PtArticle, Integer, GaFeeServiceService, GaFeeServiceModel> {

    @RequestMapping("/setArticleVisible")
    @ResponseBody
    public AjaxResponse setArticleVisible(@RequestParam("articleId") Integer articleId,
