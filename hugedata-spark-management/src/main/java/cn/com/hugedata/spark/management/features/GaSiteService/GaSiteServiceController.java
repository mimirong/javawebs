...
@Controller
@RequestMapping("/features/GaSiteService")
public class GaSiteServiceController
        extends FeatureControllerImpl<PtArticle, Integer, GaSiteServiceService, GaSiteServiceModel> {
