 ...
 */
@Controller
@RequestMapping("/features/OsDetecResourcePlatform")
public class OsDetecResourcePlatformController
        extends FeatureControllerImpl<PtArticle, Integer, OsDetecResourcePlatformService, OsDetecResourcePlatformModel> {
