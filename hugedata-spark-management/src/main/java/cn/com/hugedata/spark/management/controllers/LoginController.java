...
import cn.com.hugedata.spark.management.services.login.LoginService;
import cn.com.hugedata.spark.management.services.login.LoginService.LoginResult;
...
public class LoginController {
    ...
    public AjaxResponse doLogin(
        ...
        // 登录操作
        try {
            LoginResult result = loginService.login(loginName, password, userType, request.getSession());
    ...
    public ModelAndView logout(
            ...
            HttpServletRequest request) {
        if (StringUtils.isEmpty(redirect)) {
            redirect = urlManager.getManagementUrl();
        }
